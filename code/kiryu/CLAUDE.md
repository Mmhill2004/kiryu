...
| **Microsoft** | ✅ Active | Entra alerts, Defender for Endpoint, Secure Score, Cloud Defender, Device Compliance, Risky Users, Incidents, Machines, Intune (Devices, Policies, Apps) |
...
### Views
- **Dashboard.tsx** — Main dashboard with 10 tabs: Executive, CrowdStrike, Microsoft, Salesforce, ZIA, ZPA, ZDX, ZINS, Meraki, Intune. Executive tab is the default active tab.
